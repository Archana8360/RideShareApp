...
ActiveRecord::Schema[7.0].define(version: 2023_05_15_061147) do
  ...
  create_table "rides", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.json "selectedRouteData", default: []
  ...
  add_foreign_key "rides", "vehicles", on_delete: :cascade
end
